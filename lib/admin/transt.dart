...
class TranstScreen extends StatefulWidget {
  const TranstScreen({super.key});

  @override
  State<TranstScreen> createState() => _TranstScreenState();
}

class _TranstScreenState extends State<TranstScreen> {
  // Late variables
                                      ...
                                      ListView(
                                        ...
                                        children: List.generate(
                                          ...
                                          (index) {
                                            ...
                                            userId = doc.get('id');
                                            allType = doc.get('type');
                                            allMethod = doc.get('method');
                                            allAmt = doc.get('points');
                                            allTxnId = doc.get('txnid');
                                            allStatus = doc.get('status');
    ...
    return TableRow(
      ...
      children: cells.map((cell) {
        ...
        final cellStyle = TextStyle(
          ...
          color: cell == allTxnId ? Colors.blue.shade800 : Colors.black,
        );
